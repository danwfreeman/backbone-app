define([
  ...
  'underscore',
  'backbone',
  'text!templates/cart/final-cart-item.html',
], function($, _, backbone, finalCartItemHtml){

  var finalCartItem = Backbone.View.extend({

    initialize: function() {
        this.template = _.template(finalCartItemHtml);
    },
