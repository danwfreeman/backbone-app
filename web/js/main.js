require([
    'jquery', 'underscore', 'backbone', 'scrollable',
     'tms', 'interactive3d', 'sliderkit', 'sliderkitdelay', 'sliderkitcounter', 'sliderkittimer', 'sliderkitimagefx', 'mousewheel', 'jqueryui', 'customScrollbar',
    ...
    '../common/views/device-exchange/device-list', '../common/views/device-exchange/add', 'views/device-exchange/search',
  ...
  function ($, _, Backbone, scrollable,
    ...
    DeviceListView, AddDeviceView, SearchDeviceView,
