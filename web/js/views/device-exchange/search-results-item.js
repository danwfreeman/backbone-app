define([
...
], function($, _, backbone, modelBinder, deviceItemHtml){
  ...
  var deviceItemView = Backbone.View.extend({
    ...
    contactSeller : function (ev) {
      ...
      $('#contact-seller-dialog').dialog.model = this.model;
      $('.device-name','#contact-seller-dialog').text(this.model.get('deviceName'));
